<?php
if ( ! function_exists( 'brittany_light_color_luminance' ) ) :
	/**
	 ...
	 */
	function brittany_light_color_luminance( $color, $percent ) {
		// Remove # if provided
		if ( '#' === $color[0] ) {
...
if ( ! function_exists( 'brittany_light_hex2rgba' ) ) :
	/**
	 ...
	 * @return string
	 */
	function brittany_light_hex2rgba( $color, $opacity = false ) {

            ...
            <div class="container"> 
                <div class="row">       
                    <div class="col-lg-9 col-md-9">
                        <h1 class="search-title mb-3 text-center"><?php /* translators: %s: search term */ printf(esc_html('Search Results for: %s','multipurpose-magazine'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
                        <?php if( get_theme_mod( 'multipurpose_magazine_blog_nav_position','bottom') == 'top' || get_theme_mod( 'multipurpose_magazine_blog_nav_position','bottom') == 'both') { ?>
                        ...
                        ?>
                        <?php if( get_theme_mod( 'multipurpose_magazine_blog_nav_position','bottom') == 'bottom' || get_theme_mod( 'multipurpose_magazine_blog_nav_position','bottom') == 'both') { ?>
                            <?php if( get_theme_mod( 'multipurpose_magazine_post_navigation',true) != '') { ?>
                                <div class="navigation">
                                    <?php multipurpose_magazine_posts_pagination();?>
                                    <div class="clearfix"></div>

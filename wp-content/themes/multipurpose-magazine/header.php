            ...
            <div class="col-lg-4 col-md-4">
              <div class="logo py-4 text-center">
                ...
                <?php if ( ! empty( $blog_info ) ) : ?>
                  <?php if( get_theme_mod('multipurpose_magazine_show_site_title',true) != ''){ ?>
                  ...
                  <?php }?>
                <?php endif; ?>
                <?php if( get_theme_mod('multipurpose_magazine_show_tagline',true) != ''){ ?>
                  <?php
            ...
            <div class="col-lg-4 col-md-4">
              <div class="login text-md-right text-center">
                ...
                <?php if ( get_theme_mod('multipurpose_magazine_login_link','') != "" ) {?>
                  <a href="<?php echo esc_url(get_theme_mod('multipurpose_magazine_login_link','')); ?>"><i class="fa fa-user px-2"></i><?php echo esc_html(get_theme_mod('multipurpose_magazine_login_text','')); ?><span class="screen-reader-text"><?php esc_html_e( 'Login Button', 'multipurpose-magazine' ); ?></span></a>
                <?php }?>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row">
                          ...
                          <div class="text text-center">
                            <div class="row m-0">
                              ...
                              <div class="col-lg-3 col-md-3 col-4">
                                <div class="know-btn pl-2 mt-md-0 mt-2">
                                  <a href="<?php the_permalink(); ?>" class="blogbutton-small p-2"><?php esc_html_e('BUY NOW','multipurpose-magazine'); ?><span class="screen-reader-text"><?php esc_html_e( 'BUY NOW', 'multipurpose-magazine' ); ?></span></a>
                                </div>
                              </div>
                            </div>
                          </div>
              ...
              <div class="col-lg-6 col-md-12">
                <div class="row">
                  <div class="col-lg-4 col-md-4">
                    <div class="contact-details pt-4 mx-md-0 mx-3 text-md-left text-center">
                      <div class="row">
                        <?php if ( get_theme_mod('multipurpose_magazine_time','') != "" ) {?>
                          ...
                          <div class="col-lg-10 col-md-10 col-10 p-0">
                            <?php if ( get_theme_mod('multipurpose_magazine_time','') != "" ) {?>
                              <p class="heading pl-2 mb-1 text-left"><?php echo esc_html( get_theme_mod('multipurpose_magazine_time','')); ?></p>
                              <p class="pl-2 mb-1 text-left"><?php echo esc_html( get_theme_mod('multipurpose_magazine_time_text','')); ?></p>
                            <?php }?>
                          </div>
                        <?php }?>
                      </div>
                    ...
                    <div class="contact-details pt-4 mx-md-0 mx-3 text-md-left text-center">
                      <div class="row">
                        <?php if ( get_theme_mod('multipurpose_magazine_temperature','') != "" ) {?>
                          ...
                          <div class="col-lg-10 col-md-10 col-10 p-0">
                            <?php if ( get_theme_mod('multipurpose_magazine_temperature','') != "" ) {?>
                              <p class="heading pl-3 mb-1 text-left"><?php echo esc_html( get_theme_mod('multipurpose_magazine_temperature','')); ?></p>
                              <p class="pl-3 mb-1 text-left"><?php echo esc_html( get_theme_mod('multipurpose_magazine_temperature_text','' )); ?></p>
                            <?php }?>
                          </div>
                        <?php }?>
                      </div>
                    ...
                    <div class="contact-details pt-4 mx-md-0 mx-3 text-md-left text-center">
                      <div class="row">
                        <?php if ( get_theme_mod('multipurpose_magazine_email','') != "" ) {?>
                          ...
                          <div class="col-lg-10 col-md-10 col-10 p-0">
                            <?php if ( get_theme_mod('multipurpose_magazine_email','') != "" ) {?>
                              <p class="heading pl-2 mb-1 text-left"><a href="mailto:<?php echo esc_attr( get_theme_mod('multipurpose_magazine_email','')); ?>"><?php echo esc_html( get_theme_mod('multipurpose_magazine_email','')); ?><span class="screen-reader-text"><?php esc_html_e('Email', 'multipurpose-magazine') ?></span></a></p>
                              <p class="pl-2 mb-1 text-left"><?php echo esc_html( get_theme_mod('multipurpose_magazine_email_text','')); ?></p>
                            <?php }?>
                          </div>
                        <?php }?>
                      </div>
        ...
        <div class="container"> 
          <div id="sidelong-menu" class="nav side-nav">
            <nav id="primary-site-navigation" class="nav-menu" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'multipurpose-magazine' ); ?>">
              ...
              <a href="javascript:void(0)" class="closebtn responsive-menu"><?php esc_html_e('Close Menu','multipurpose-magazine'); ?><i class="fas fa-times-circle m-3"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','multipurpose-magazine'); ?></span></a>
            </nav>
          </div>
        </div>
      </div>

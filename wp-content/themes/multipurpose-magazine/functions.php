...
function multipurpose_magazine_setup() {
	...
	load_theme_textdomain( 'multipurpose-magazine', get_template_directory() . '/languages' );
...
function multipurpose_magazine_scripts() {
	...
	wp_enqueue_style( 'multipurpose-magazine-block-style', get_theme_file_uri('/css/blocks-style.css') );

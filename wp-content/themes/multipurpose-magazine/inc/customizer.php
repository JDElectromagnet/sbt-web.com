...
function multipurpose_magazine_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('multipurpose_magazine_blog_nav_position',array(
        'default' => 'bottom',
        'sanitize_callback' => 'multipurpose_magazine_sanitize_choices'
    ));
	$wp_customize->add_control('multipurpose_magazine_blog_nav_position', array(
        'type' => 'select',
        'label' => __( 'Blog Post Navigation Position', 'multipurpose-magazine' ),
        'section' => 'multipurpose_magazine_theme_layout',
        'choices' => array(
            'top' => __('Top','multipurpose-magazine'),
            'bottom' => __('Bottom','multipurpose-magazine'),
            'both' => __('Both','multipurpose-magazine')
        ),
    ));
	...
	$wp_customize->add_setting('multipurpose_magazine_single_post_breadcrumb',array(
       'default' => 'true',
       'sanitize_callback'	=> 'multipurpose_magazine_sanitize_checkbox'
    ));
    $wp_customize->add_control('multipurpose_magazine_single_post_breadcrumb',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Single Post Breadcrumb','multipurpose-magazine'),
    ...
    $wp_customize->add_setting('multipurpose_magazine_shop_page_navigation',array(
       'default' => true,
       'sanitize_callback'	=> 'multipurpose_magazine_sanitize_checkbox'
    ));
    $wp_customize->add_control('multipurpose_magazine_shop_page_navigation',array(
       'type' => 'checkbox',
       'label' => __('Enable Shop Page Pagination','multipurpose-magazine'),
       'section' => 'multipurpose_magazine_woocommerce'
    ));

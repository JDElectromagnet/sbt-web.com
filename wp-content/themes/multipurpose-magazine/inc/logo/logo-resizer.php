...
function multipurpose_magazine_logo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('multipurpose_magazine_show_site_title',array(
       'default' => true,
       'sanitize_callback' => 'multipurpose_magazine_sanitize_checkbox'
    ));
    $wp_customize->add_control('multipurpose_magazine_show_site_title',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Site Title','multipurpose-magazine'),
       'section' => 'title_tagline'
    ));

    $wp_customize->add_setting('multipurpose_magazine_show_tagline',array(
       'default' => true,
       'sanitize_callback' => 'multipurpose_magazine_sanitize_checkbox'
    ));
    $wp_customize->add_control('multipurpose_magazine_show_tagline',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Site Tagline','multipurpose-magazine'),
       'section' => 'title_tagline'
    ));
}

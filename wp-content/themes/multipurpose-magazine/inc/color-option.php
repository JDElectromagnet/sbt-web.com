<?php
	...
	$multipurpose_magazine_shop_page_navigation = get_theme_mod('multipurpose_magazine_shop_page_navigation',true);
	if ($multipurpose_magazine_shop_page_navigation == false) {
		$multipurpose_magazine_custom_css .='.woocommerce nav.woocommerce-pagination{';
			$multipurpose_magazine_custom_css .='display: none;';
		$multipurpose_magazine_custom_css .='}';
	}
...
<?php if( get_theme_mod( 'multipurpose_magazine_hide_scroll',true) != '') { ?>
  ...
  if($multipurpose_magazine_scroll_align == 'Left'){ ?>
    <a href="#content" class="back-to-top scroll-left text-center"><?php esc_html_e('Top', 'multipurpose-magazine'); ?><span class="screen-reader-text"><?php esc_html_e('Back to Top', 'multipurpose-magazine'); ?></span></a>
  <?php }else if($multipurpose_magazine_scroll_align == 'Center'){ ?>
    <a href="#content" class="back-to-top scroll-center text-center"><?php esc_html_e('Top', 'multipurpose-magazine'); ?><span class="screen-reader-text"><?php esc_html_e('Back to Top', 'multipurpose-magazine'); ?></span></a>
  <?php }else{ ?>
    <a href="#content" class="back-to-top scroll-right text-center"><?php esc_html_e('Top', 'multipurpose-magazine'); ?><span class="screen-reader-text"><?php esc_html_e('Back to Top', 'multipurpose-magazine'); ?></span></a>
  <?php }?>
<?php }?>

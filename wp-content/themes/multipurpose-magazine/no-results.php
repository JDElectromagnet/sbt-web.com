...
<?php else : ?>
	...
	<div class="read-moresec mt-3">
		<a href="<?php echo esc_url( home_url() ); ?>" class="button py-2 px-4"><?php esc_html_e( 'Return to the home page', 'multipurpose-magazine' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Return to the home page', 'multipurpose-magazine' ); ?></span></a>
	</div>
<?php endif; ?>
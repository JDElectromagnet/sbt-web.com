...
<article>
	...
	<?php if( get_theme_mod( 'multipurpose_magazine_single_post_date',true) != '' || get_theme_mod( 'multipurpose_magazine_single_post_author',true) != '' || get_theme_mod( 'multipurpose_magazine_single_post_comment_no',true) != '') { ?>
    	<div class="post-info">
			<?php if( get_theme_mod( 'multipurpose_magazine_single_post_date',true) != '') { ?>
				<i class="fa fa-calendar" aria-hidden="true"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><span class="entry-date ml-2 mr-3"><?php echo esc_html( get_the_date() ); ?></span><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a>
			<?php }?>
			<?php if( get_theme_mod( 'multipurpose_magazine_single_post_author',true) != '') { ?>
				<i class="fa fa-user" aria-hidden="true"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><span class="entry-author ml-2 mr-3"> <?php the_author(); ?></span><span class="screen-reader-text"><?php the_author(); ?></span></a>
			<?php }?>
			<?php if( get_theme_mod( 'multipurpose_magazine_single_post_comment_no',true) != '') { ?>
				<i class="fa fa-comments" aria-hidden="true"></i><span class="entry-comments ml-2 mr-3"> <?php comments_number( __('0 Comments','multipurpose-magazine'), __('0 Comments','multipurpose-magazine'), __('% Comments','multipurpose-magazine') ); ?></span> 
			<?php }?>
	    </div>
	<?php }?>
	...
	<?php 
	wp_link_pages( array(
		'before'      => '<div class="page-links"><span class="page-links-title p-3">' . __( 'Pages:', 'multipurpose-magazine' ) . '</span>',
		'after'       => '</div>',
		'link_before' => '<span>',
		'link_after'  => '</span>',
